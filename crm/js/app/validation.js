...
function dynamic_datetime_ws(id) { //new function without seconds
	id = id.trim();
	jQuery('#' + id).datetimepicker({ format: 'd-m-Y H:i' });
	jQuery('#' + id).addClass('form-control');
}
...
function foo(tableID, quot_table_id, rowCounts) {
	...
	if (tableID == 'tbl_member_dynamic_row') {
		...
		$(row.cells[11].childNodes[0]).datetimepicker({ timepicker: false, format: "d-m-Y" });
		row.cells[12].childNodes[0].setAttribute('id', 'txt_m_passport_expiry_date' + foo.counter);
		$(row.cells[12].childNodes[0]).datetimepicker({ timepicker: false, format: "d-m-Y" });
		if (row.cells[13]) {
	...
	if (tableID == 'tbl_plane_travel_details_dynamic_row' || tableID == 'tbl_plane_travel_details_dynamic_row_update') {
		...
		$(row.cells[2].childNodes[0]).click(function () { $('.tooltip').remove() })
		...
		row.cells[2].childNodes[0].setAttribute('onchange', "get_to_datetime(id,'" + row.cells[8].childNodes[0].id + "')");
		row.cells[8].childNodes[0].setAttribute('onchange', "validate_validDatetime('" + row.cells[2].childNodes[0].id + "',id)");
	...
	if (tableID == 'tbl_grp_packages_datewise') {
		...
		row.cells[2].childNodes[0].setAttribute('onchange', 'tour_groups_reflect(id)');
	}
	...
	if (tableID == 'tbl_meta_tags') {
		row.cells[0].childNodes[0].setAttribute('id', 'chk_meta_tags1' + foo.counter);
		row.cells[2].childNodes[0].setAttribute('id', 'page-1' + foo.counter);
		row.cells[3].childNodes[0].setAttribute('id', 'title-1' + foo.counter);
		row.cells[4].childNodes[0].setAttribute('id', 'description-1' + foo.counter);
	...
	if (tableID == 'tbl_package_hotel_infomration') {
		...
		row.cells[4].childNodes[0].setAttribute('onchange', 'get_to_datetime(\'txt_hotel_from_date' + foo.counter + '\', \'txt_hotel_to_date' + foo.counter + '\')');
	...
	if (tableID == 'tbl_package_transport_infomration') {
		...
		for (var i = row.cells[4].childNodes[0].attributes.length; i-- > 0;)
			row.cells[4].childNodes[0].removeAttributeNode(row.cells[4].childNodes[0].attributes[i]);
		row.cells[4].childNodes[0].setAttribute('id', 'txt_tsp_end_date' + foo.counter);
		row.cells[4].childNodes[0].setAttribute('style', 'width: 170px');
		...
		row.cells[3].childNodes[0].setAttribute('onchange', "get_to_date(id,'" + row.cells[4].childNodes[0].id + "')");
		row.cells[4].childNodes[0].setAttribute('onchange', "validate_validDate('" + row.cells[3].childNodes[0].id + "',id)");
	...
	if (tableID == 'tbl_package_tour_quotation_dynamic_hotel' || tableID == 'tbl_package_tour_quotation_dynamic_hotel_update') {
		...
		row.cells[2].childNodes[0].setAttribute('id', 'package_type' + prefix + foo.counter);

		row.cells[3].childNodes[0].setAttribute('id', 'city_name' + prefix + foo.counter);
		$(row.cells[3].childNodes[0]).next("span").remove();
		row.cells[4].childNodes[0].setAttribute('id', 'hotel_name-' + prefix + foo.counter);
		row.cells[5].childNodes[0].setAttribute('id', 'room_cat-' + prefix + foo.counter);

		for (var i = row.cells[6].childNodes[0].attributes.length; i-- > 0;)
			row.cells[6].childNodes[0].removeAttributeNode(row.cells[6].childNodes[0].attributes[i]);
		row.cells[6].childNodes[0].setAttribute('id', 'check_in-' + prefix + foo.counter);
		row.cells[6].childNodes[0].placeholder = '*Check-In Date';
		dynamic_date(row.cells[6].childNodes[0].id);

		for (var i = row.cells[7].childNodes[0].attributes.length; i-- > 0;)
			row.cells[7].childNodes[0].removeAttributeNode(row.cells[7].childNodes[0].attributes[i]);
		row.cells[7].childNodes[0].setAttribute('id', 'check_out-' + prefix + foo.counter);
		row.cells[7].childNodes[0].placeholder = '*Check-Out Date';
		dynamic_date(row.cells[7].childNodes[0].id);

		row.cells[8].childNodes[0].setAttribute('id', 'hotel_type-' + prefix + foo.counter);
		row.cells[9].childNodes[0].setAttribute('id', 'hotel_stay_days-' + prefix + foo.counter);
		row.cells[10].childNodes[0].setAttribute('id', 'no_of_rooms-' + prefix + foo.counter);
		row.cells[11].childNodes[0].setAttribute('id', 'extra_bed-' + prefix + foo.counter);
		row.cells[12].childNodes[0].setAttribute('id', 'package_name' + prefix + foo.counter);
		row.cells[13].childNodes[0].setAttribute('id', 'hotel_cost' + prefix + foo.counter);
		row.cells[14].childNodes[0].setAttribute('id', 'package_id' + prefix + foo.counter);
		row.cells[15].childNodes[0].setAttribute('id', 'extra_bed_cost-' + prefix + foo.counter);
		...
		row.cells[6].childNodes[0].setAttribute('onchange', 'get_auto_to_date(id);get_hotel_cost();');
		row.cells[7].childNodes[0].setAttribute('onchange', 'calculate_total_nights(id);validate_validDates(id);get_hotel_cost();');
		row.cells[0].childNodes[0].setAttribute('onchange', 'get_hotel_cost();');
		row.cells[4].childNodes[0].setAttribute('onchange', 'hotel_type_load(id);get_hotel_cost();');
	...
	if (tableID == 'tbl_package_tour_quotation_dynamic_transport' || tableID == 'tbl_package_tour_quotation_dynamic_transport_u') {
		...
		row.cells[4].childNodes[0].setAttribute('id', 'transport_end_date-' + foo.counter);
		row.cells[5].childNodes[0].setAttribute('id', 'pickup_from-' + foo.counter);
		row.cells[6].childNodes[0].setAttribute('id', 'drop_to-' + foo.counter);
		row.cells[7].childNodes[0].setAttribute('id', 'no_vehicles-' + foo.counter);
		row.cells[8].childNodes[0].setAttribute('id', 'transport_cost-' + foo.counter);
		row.cells[9].childNodes[0].setAttribute('id', 'package_name-' + foo.counter);
		row.cells[10].childNodes[0].setAttribute('id', 'package_id-' + foo.counter);
		row.cells[11].childNodes[0].setAttribute('id', 'pickup_type-' + foo.counter);
		...
		row.cells[3].childNodes[0].setAttribute('onchange', fun_name+";get_to_date(id,'" + row.cells[4].childNodes[0].id + "')");
		row.cells[4].childNodes[0].setAttribute('onchange', "validate_validDate('" + row.cells[3].childNodes[0].id + "',id)");
		...
		jQuery(row.cells[3].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y' });
		row.cells[4].childNodes[0].value = today;
		dynamic_datetime(row.cells[4].childNodes[0].id);
		jQuery(row.cells[4].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y' });
	...
	if (tableID == 'tbl_package_tour_quotation_dynamic_excursion') {
		...
		row.cells[8].childNodes[0].setAttribute('id', 'childwo-' + foo.counter);
		row.cells[9].childNodes[0].setAttribute('id', 'infant-' + foo.counter);
		row.cells[10].childNodes[0].setAttribute('id', 'excursion_amount-' + foo.counter);
		...
		row.cells[2].childNodes[0].value = today;
		dynamic_datetime(row.cells[2].childNodes[0].id);
		jQuery(row.cells[2].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y H:i' });
		...
		row.cells[6].childNodes[0].setAttribute('onchange', 'validate_pax_count(id,"Adult");'+function_name);
		row.cells[7].childNodes[0].setAttribute('onchange', 'validate_pax_count(id,"ChildWithBed");'+function_name);
		row.cells[8].childNodes[0].setAttribute('onchange', 'validate_pax_count(id,"ChildWithoutBed");'+function_name);
		row.cells[9].childNodes[0].setAttribute('onchange', 'validate_pax_count(id,"Infant");'+function_name);
		
		row.cells[10].style.display = 'none';
		row.cells[11].childNodes[0].setAttribute('id', 'adult_total-' + foo.counter);
		row.cells[12].childNodes[0].setAttribute('id', 'child_total-' + foo.counter);
		row.cells[13].childNodes[0].setAttribute('id', 'childwo_total-' + foo.counter);
		row.cells[14].childNodes[0].setAttribute('id', 'infant_total-' + foo.counter);
		row.cells[11].style.display = 'none';
		row.cells[12].style.display = 'none';
		row.cells[13].style.display = 'none';
		row.cells[14].style.display = 'none';
	...
	if (tableID == 'tbl_package_tour_quotation_dynamic_costing') {
		...
		row.cells[8].childNodes[1].setAttribute('id', 'service_tax_subtotal-' + foo.counter);
		row.cells[9].childNodes[1].setAttribute('id', 'total_tour_cost-' + foo.counter);
		row.cells[10].childNodes[1].setAttribute('id', 'package_name1' + foo.counter);
		row.cells[11].childNodes[1].setAttribute('id', 'package_id' + foo.counter);
	...
	if (tableID == 'tbl_package_tour_quotation_dynamic_train') {
		...
		row.cells[5].childNodes[0].setAttribute('onchange', "get_to_datetime(id,'" + row.cells[6].childNodes[0].id + "')");
		row.cells[6].childNodes[0].setAttribute('onchange', "validate_validDatetime('" + row.cells[5].childNodes[0].id + "',id)");

		jQuery(row.cells[5].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y H:i' });
		jQuery(row.cells[6].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y H:i' });
	...
	if (
		...
		for (var i = row.cells[7].childNodes[0].attributes.length; i-- > 0;)
			row.cells[7].childNodes[0].removeAttributeNode(row.cells[7].childNodes[0].attributes[i]);
		row.cells[7].childNodes[0].setAttribute('id', 'train_arrival_date-' + foo.counter);
		...
		row.cells[6].childNodes[0].setAttribute('onchange', "get_to_datetime(id,'" + row.cells[7].childNodes[0].id + "')");
		row.cells[7].childNodes[0].setAttribute('onchange', "validate_validDatetime('" + row.cells[6].childNodes[0].id + "',id)");
		jQuery(row.cells[6].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y H:i' });
		jQuery(row.cells[7].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y H:i' });
	...
	if (tableID == 'tbl_flight_quotation_dynamic_plane' || tableID == 'tbl_flight_quotation_dynamic_plane_update') {
		...
		row.cells[9].childNodes[0].setAttribute('onchange', "get_to_datetime(id,'" + row.cells[10].childNodes[0].id + "')");
		jQuery(row.cells[9].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y H:i' });
		jQuery(row.cells[10].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y H:i' });
		row.cells[10].childNodes[0].setAttribute('onchange', "validate_validDatetime('" + row.cells[9].childNodes[0].id + "',id)");
		row.cells[10].childNodes[0].setAttribute('type', 'text');
		row.cells[10].childNodes[0].style.width = '140px';
	...
	if (tableID == 'tbl_dynamic_cruise_quotation' || tableID == 'tbl_dynamic_cruise_quotation_update') {
		...
		row.cells[2].childNodes[0].setAttribute('onchange', "get_to_datetime(id,'" + row.cells[3].childNodes[0].id + "')");
		row.cells[3].childNodes[0].setAttribute('onchange', "validate_validDatetime('" + row.cells[2].childNodes[0].id + "',id)");
		jQuery(row.cells[2].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y H:i' });
		jQuery(row.cells[3].childNodes[0]).addClass('form-control').datetimepicker({ format: 'd-m-Y H:i' });
	...
	if (tableID == 'tbl_dynamic_cruise_package_booking') {
		...
		$(row.cells[3].childNodes[0]).click(function () { $('.tooltip').remove() })
		var today = new Date();
		var dd = today.getDate();
		var mm = today.getMonth() + 1; //January is 0!
		var hour = today.getHours();
	...
	if (tableID == 'tbl_hotel_booking' || tableID == 'tbl_hotel_booking_update') {
		...
		row.cells[4].childNodes[0].setAttribute('onchange', 'get_to_datetime(this.id,\'check_out' + foo.counter + '\');calculate_total_nights(\'check_in' + foo.counter + '\', \'check_out' + foo.counter + '\',\'no_of_nights' + prefix + foo.counter + '\')');
		...
		row.cells[5].childNodes[0].setAttribute('onchange', 'calculate_total_nights(\'check_in' + foo.counter + '\', \'check_out' + foo.counter + '\',\'no_of_nights' + prefix + foo.counter + '\')');
	...
	if (tableID == 'tbl_dynamic_visa' || tableID == 'tbl_dynamic_visa_update') {
		...
		row.cells[0].childNodes[0].setAttribute('onchange', 'reflect_cost(this.id)');
		...
		if(tableID == 'tbl_dynamic_visa_update'){
			row.cells[11].childNodes[0].setAttribute('onchange', 'validate_issueDate("issue_date_u"+foo.counter,"expiry_date_u"+foo.counter)');
		}else{
			row.cells[11].childNodes[0].setAttribute('onchange', 'validate_issueDate("issue_date"+foo.counter,"expiry_date"+foo.counter)');
		}
		...
		row.cells[14].childNodes[0].setAttribute('title', 'Appointment Date');
		var today = new Date();
		var dd = today.getDate();
		var mm = today.getMonth() + 1; //January is 0!
	...
	if (tableID == 'tbl_dynamic_miscellaneous' || tableID == 'tbl_dynamic_miscellaneous_update') {
		...
		row.cells[8].childNodes[0].setAttribute('onchange', 'validate_futuredate(id)');
		row.cells[9].childNodes[0].setAttribute('onchange', 'validate_pastDate(id)');
		$(row.cells[10]).addClass('hidden');
	}
	...
	if (tableID == 'tbl_dynamic_ticket_master') {
		...
		row.cells[12].childNodes[0].setAttribute('class', 'form-control main_ticket');
		$(row.cells[13]).addClass('hidden');
		if(row.cells[14])
			$(row.cells[14]).addClass('hidden');
	...
	if (tableID == 'table_hotel_tarrif' + quot_table_id || tableID == 'table_hotel_tarrif_update') {
		...
		row.cells[5].childNodes[0].setAttribute('onchange', 'validate_validDate("from_date"+foo.counter,"to_date"+foo.counter)');
		if (row.cells[21]) {
	...
	if (tableID == 'table_hotel_tarrif_offer') {
		...
		row.cells[4].childNodes[0].setAttribute('onchange', 'validate_validDate("from_date_h"+foo.counter,"to_date_h"+foo.counter)');
	...
	if (tableID == 'table_transfer_tarrif') {
		...
		row.cells[6].childNodes[0].setAttribute('onchange', 'validate_validDate("from_date"+foo.counter,"to_date"+foo.counter)');
	...
	if (tableID == 'table_exc_tarrif_basic') {
		...
		row.cells[3].childNodes[0].setAttribute('id', 'from_date_basic' + foo.counter);
		row.cells[4].childNodes[0].setAttribute('id', 'to_date_basic' + foo.counter);
		...
		$('#' + row.cells[3].childNodes[0].id).datetimepicker({ timepicker: false, format: 'd-m-Y' });
		$('#' + row.cells[4].childNodes[0].id).datetimepicker({ timepicker: false, format: 'd-m-Y' });

		row.cells[3].childNodes[0].setAttribute('onchange', 'get_to_date(id,"'+row.cells[4].childNodes[0].id+'")');
		row.cells[4].childNodes[0].setAttribute('onchange', 'validate_validDate("'+row.cells[3].childNodes[0].id+'","'+row.cells[4].childNodes[0].id+'")');
	...
	if (tableID == 'tbl_package_tariff') {
		...
		row.cells[10].childNodes[0].setAttribute('id', 'binfant_cost' + foo.counter);
		...
		row.cells[15].childNodes[0].setAttribute('id', 'cinfant_cost' + foo.counter);
	...
	if (tableID == 'table_ferry_tarrif' || tableID == 'table_ferry_tarrif_update') {
		...
		if(tableID == 'table_ferry_tarrif_update'){
			row.cells[15].childNodes[0].setAttribute('id', 'ucurrency_code' + foo.counter);
		}
		...
		$('#' + row.cells[3].childNodes[0].id).datetimepicker({ timepicker: false, format: 'd-m-Y' });
		$('#' + row.cells[4].childNodes[0].id).datetimepicker({ timepicker: false, format: 'd-m-Y' });
		row.cells[3].childNodes[0].setAttribute('onchange', 'get_to_date(id,"to_date"+foo.counter)');
		row.cells[4].childNodes[0].setAttribute('onchange', 'validate_validDate("from_date"+foo.counter,"to_date"+foo.counter)');
		...
		$('#' + row.cells[7].childNodes[0].id).datetimepicker({ timepicker: true, format: 'd-m-Y H:i' });
		$('#' + row.cells[8].childNodes[0].id).datetimepicker({ timepicker: true, format: 'd-m-Y H:i' });
		row.cells[7].childNodes[0].setAttribute('onchange', 'get_to_datetime(id,"arrival_date"+foo.counter)');
		row.cells[8].childNodes[0].setAttribute('onchange', 'validate_validDatetime("dept_date"+foo.counter,"arrival_date"+foo.counter)');
		if(tableID == 'table_ferry_tarrif_update'){
			$(row.cells[16]).addClass('hidden');
		}else{
			$(row.cells[15]).addClass('hidden');
	...
	if (tableID == 'table_bike_tarrif') {
		...
		row.cells[2].childNodes[0].setAttribute('id', 'city_id' + foo.counter);
		row.cells[3].childNodes[0].setAttribute('id', 'pickup_location' + foo.counter);
		row.cells[4].childNodes[0].setAttribute('id', 'from_date' + foo.counter);
		row.cells[5].childNodes[0].setAttribute('id', 'to_date' + foo.counter);
		...
		row.cells[11].childNodes[0].setAttribute('id', 'markup_amount' + foo.counter);
	...
	if (tableID == 'table_bike_tarrif_offer') {
		...
		dynamic_date(row.cells[4].childNodes[0].id);
		$('#' + row.cells[8].childNodes[0].id).select2();
		row.cells[3].childNodes[0].setAttribute('onchange', 'get_to_date(id,"to_dateo"+foo.counter)');
		row.cells[4].childNodes[0].setAttribute('onchange', 'validate_validDate("from_dateo"+foo.counter,"to_dateo"+foo.counter)');
...
function addRow(tableID, quot_table = '',itinerary='') {
	...
	for (var i = 0; i < colCount; i++) {
		...
		newcell.childNodes[0].title = (table.rows[0].cells[i].childNodes[0].title != "") ? table.rows[0].cells[i].childNodes[0].title : table.rows[0].cells[i].childNodes[0].getAttribute('data-original-title');
