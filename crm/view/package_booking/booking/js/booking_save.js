												...
												if (result == 'yes') {
													...
													$.post(
														...
														'controller/package_tour/booking/package_tour_booking_master_save_c.php',
														{
															...
															basic_amount: basic_amount, bsmValues: bsmValues, roundoff: roundoff, credit_amount_arr: credit_amount_arr, credit_charges_arr: credit_charges_arr, credit_card_details_arr: credit_card_details_arr,tcs_tax:tcs_tax,tcs:tcs, package_type : package_type
														},
														function (data) {
															var msg1 = data.split('-');
